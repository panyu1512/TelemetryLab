...
const BRAND_ICONS: Record<string, () => JSX.Element> = {
  ...
  /* Renault — the losange: an outer diamond band with the ribbon crossing
     through it. A diamond nested in a diamond misses the interlock entirely. */
  Renault: () => (
    <svg viewBox="10 0 80 100" fill="currentColor" fillRule="evenodd">
